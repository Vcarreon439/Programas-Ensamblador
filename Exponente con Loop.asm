...
.data
    ...
    msm db "Ingrese la base: $"
    msm2 db 10,13, "Ingrese la potencia: $"
...
MOV AH, 00
SUB AL, 30H
MOV BX, AX      ;Guardamos en BX la base

Solicitar_Num msm2
MOV AH, 00
SUB AL, 30H
MOV CX, AX      ;Guardamos en CX la potencia

MOV AX,1        ;Reestablecer el valor de ax para comenzar el factorial
 
Factorial:                    
            
MUL BX          ;Para el calculo de la potencia, BX se multiplica con AX
